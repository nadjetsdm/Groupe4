...
OBJECT_URLS = [
        ...
        'https://www.google.fr/maps/place/CPAM+de+Paris/@48.8836736,2.3183759,17.44z/data=!4m6!3m5!1s0x47e66fb3b66a322b:0x99afd85505a11a6a!8m2!3d48.8840113!4d2.3201583!16s%2Fg%2F11b6bbzl2x',
...
def scrape_an_object(object_url: str) -> tuple :
 ...
 # setting the chrome driver for selenium
  ...
  # scraping each individual review
    ...
    reviews_source = response.find_all('div', class_='')
    ...
    return store_main_data, response
...
def extract_reviews(reviews_source: list) -> list:
    ...
    user = reviews_source.find_all('div', class_= 'd4r55')
    date = reviews_source.find_all('span', class_= 'rsqaWe')
    review_text = reviews_source.find_all('span', class_= 'wiI7pd')
    ...
    for element in review_text :
        reviews.append('' if element is None else element.text)
    ...
    for i in range(len(reviews)) :
        review_list.append({'user':users[i],
                            'date': dates[i],
